...
## Corpus Check
- 137 files · ~553,525 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 875 nodes · 1662 edges · 88 communities (71 shown, 17 thin omitted)
...
Cohesion: 0.10
Nodes (22): confidenceSummary(), AnalyticsView, ComparisonSummary, ComplexDealGroup, ComplexDealMovement, ComplexDealSnapshot, DeepSignal, DeltaRow (+14 more)
...
### Community 5 - "fmt"
Cohesion: 0.42
Nodes (12): App(), CompactDiagnostics(), ContributionRows(), expandLabel(), ManagerDetail(), ManagerScatter(), MoodSurveySection(), share() (+4 more)
...
Cohesion: 0.11
Nodes (17): AnalysisControls(), data, DriverView, managerScopeOptions, pairOptions, periodLabel, pilotManagerKeys, productScopeOptions (+9 more)
...
### Community 41 - "data-integrity.test.ts"
Cohesion: 0.18
Nodes (11): comparisonKeys, data, snapshotPeriods, viewKeys, pct(), buildDeepSignals(), buildSignals(), contribution() (+3 more)
...
Cohesion: 0.20
Nodes (6): data, colors, PeriodVessels(), StageRow, AnalyticsDataset, SnapshotPeriod
